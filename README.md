...
`create`, `read`, `update`, `delete` 기능을 구현한 게시판 사이트를 만들어보려고 한다.
...
- [PHP](https://opentutorials.org/course/3130)
  - [PHP & MySQL](https://opentutorials.org/course/3167)
- [MySQL(MariaDB)](https://opentutorials.org/course/3161)
